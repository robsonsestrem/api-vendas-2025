...
describe('InMemoryRepository unit tests', () => {
  ...
  describe('search', () => {
    /**
     * Quando o método search não recebe nenhum parâmetro de busca personalizada, retorna o padrão 
     * que é página 1, 15 itens por página, sem ordenação e sem filtro.
     */
    it('should paginate items', async () => {
    ...
    /**
     * Quando o método search recebe os parâmetros de paginação e ordenação,
     * aplica a paginação e ordenação corretamente.
     */
    ...
    /**
     * Quando o método search recebe os parâmetros de paginação, ordenação e filtro,
     * aplica a paginação, ordenação e filtro corretamente.
     */
